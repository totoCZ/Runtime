<?php //netteCache[01]000205a:2:{s:4:"time";s:21:"0.84448000 1382042579";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:35:"/opt/lampp/htdocs/lib/nette.min.php";i:2;i:1382042544;}}}?><?php
...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, nette.presenterFactory, router, nette.mailer, nette.database, container,
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/opt/lampp/htdocs',
			'wwwDir' => '/opt/lampp/htdocs',
			'debugMode' => TRUE,
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/opt/lampp/htdocs/tmp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/opt/lampp/htdocs/tmp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/opt/lampp/htdocs', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/opt/lampp/htdocs/tmp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
